...
function getTypeTooltip(type: string): string {
  switch (type) {
    ...
    case "genesis_transaction":
      return "";
    case "user_transaction":
      return "A transaction generated by users of the CheckDot blockchain.";
    case "pending_transaction":
      return "";
    case "state_checkpoint_transaction":
      return "System-generated transactions that save the latest state of the CheckDot blockchain.";
    default:
      throw `Unknown TransactionType:${type}`;
  }
}
